...
export default function ScrollCounter({ total }: { total: number }) {
  ...
  return (
    <div
      className="pointer-events-none fixed z-20 blend-difference leading-none tabular-nums text-[2em] top-6 left-5 lg:text-[3em] lg:top-1/2 lg:left-auto lg:right-0 lg:pr-8 lg:-translate-y-1/2"
